...
public class PlayerMovement : MonoBehaviour {
	...
	public float mudSpeed	= 2.0f;
	public float resetTurnSpeed = 0.0f;

	public float currentSpeed = 0.0f;
	public float currentAngularVelocity = 0.0f;
	...
	void FixedUpdate () {
		...
		currentAngularVelocity = Mathf.Abs (transform.InverseTransformDirection (rigidb.angularVelocity).y);
